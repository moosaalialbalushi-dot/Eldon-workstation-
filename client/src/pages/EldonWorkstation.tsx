                ...
                <div className="space-y-4 mb-8">
                  {availableAIs.filter(ai => ai.id !== 'master-skill').map(ai => (
                    <div key={ai.id}>
                      ...
                      <input type="password" placeholder="Managed securely via backend routes..." className="w-full bg-[#1a1a1a] border border-gray-800 rounded-lg px-3 py-2 text-sm text-gray-300 focus:border-amber-500 focus:outline-none" />
                    </div>
                  ))}
                </div>
